 ...
 */
// lptrung
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 500, 25 }  //{ 500, 500, 5, 25 }
 ...
 */
//lptrung
//#define NOZZLE_TO_PROBE_OFFSET { -43.3, -6.38, -1.783 }
#define NOZZLE_TO_PROBE_OFFSET { 0, 25, -1.783 }
...
//lptrung					
#define HOMING_FEEDRATE_XY (80*60) ///(50*60)
