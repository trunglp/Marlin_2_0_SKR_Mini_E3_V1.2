...
//https://www.youtube.com/watch?v=ywf0G8mRjnY
/**
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.2, 80.2, 400, 95.5 }
 ...
 */
//lptrung change		   
#define NOZZLE_TO_PROBE_OFFSET { 48, -2, -0.8 }
...
#define LEVEL_BED_CORNERS
  ...
  //lptrung change
  #define LEVEL_CORNERS_HEIGHT    0.1  // 0.0   // (mm) Z height of nozzle at leveling points
...
// Homing speeds (mm/m)
// lptrung change 
#define HOMING_FEEDRATE_XY  (50*60) // (20*60)
