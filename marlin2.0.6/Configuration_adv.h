...
//#define ASSISTED_TRAMMING
   ...
   */
  //lptrung change
  #define TRAMMING_SCREW_THREAD 40 //30
...
//lptrung change
  ...
  //lptrung change
    #define DOUBLECLICK_MAX_INTERVAL 800 //1250   // Maximum interval between clicks, in milliseconds.
                                            // Note: Extra time may be added to mitigate controller latency.
    //#define BABYSTEP_ALWAYS_AVAILABLE     // Allow babystepping at all times (not just during movement).
    //#define MOVE_Z_WHEN_IDLE              // Jump to the move Z menu on doubleclick when printer is idle.
    #if ENABLED(MOVE_Z_WHEN_IDLE)
    //lptrung change
      #define MOVE_Z_IDLE_MULTIPLICATOR 10  //1  // Multiply 1mm by this factor for the move step size.
    #endif
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  //lptrung change
  #define FILAMENT_CHANGE_UNLOAD_LENGTH   120 //   400  // (mm) The length of filament for a complete unload.
